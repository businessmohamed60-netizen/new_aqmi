    ...
    <div class="aqmi-results-actions">
      ...
      <?php if ($hasNoRequest): ?>
        <form method="GET" action="/assessment/<?= $assessment['id'] ?>/request-report" style="display:inline;">
          <button type="submit" class="btn btn-primary" style="background:linear-gradient(135deg,var(--aqmi-accent),var(--aqmi-warning));border:none;box-shadow:0 4px 20px var(--aqmi-accent-glow);">

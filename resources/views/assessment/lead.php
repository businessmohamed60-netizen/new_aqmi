...
<div class="aqmi-lead-wrap">
  <div class="aqmi-lead-card" style="animation: aqmi-fade-in 0.6s ease;">
    <div style="text-align:center;margin-bottom:1.5rem;">
      ...
      <h1 class="aqmi-lead-title">Presque terminé !</h1>
      <p class="aqmi-lead-subtitle">Renseignez vos informations pour générer votre rapport de maturité qualité personnalisé.</p>
    </div>
    ...
    <form method="GET" action="/assessment/save-lead" novalidate>
      <?= csrf_field() ?>
      ...
      <button type="submit" class="aqmi-lead-submit">
        <i class="fas fa-file-alt" style="margin-right:0.5rem;"></i> Générer mon rapport personnalisé
      </button>

                ...
                <div class="card mb-3"><div class="card-body">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="color" name="primary_color" class="form-control form-control-color" value="<?= e($th['primary_color'] ?? '#0d47a1') ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Couleur secondaire</label>
                            <input type="color" name="secondary_color" class="form-control form-control-color" value="<?= e($th['secondary_color'] ?? '#546e7a') ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Couleur accent</label>
                            <input type="color" name="accent_color" class="form-control form-control-color" value="<?= e($th['accent_color'] ?? '#00897b') ?>">
                        </div>
                    </div>
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">

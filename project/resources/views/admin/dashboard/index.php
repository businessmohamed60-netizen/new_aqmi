...
document.addEventListener('DOMContentLoaded', function() {
            ...
            plotOptions: {
                radialBar: {
                    ...
                    dataLabels: {
                        ...
                        value: { offsetY: 20, color: '#f1f5f9', fontSize: '2.2rem', fontWeight: 800, formatter: function(v) { return v + '%'; } }
                    },
                ...
                pie: {
                    donut: {
                        ...
                        labels: {
                            ...
                            value: { color: '#f1f5f9', fontSize: '1.5rem', fontWeight: 800 },
    ...
    if (document.getElementById('domainBars')) {
        new ApexCharts(document.getElementById('domainBars'), {
            ...
            dataLabels: { enabled: true, textAnchor: 'middle', formatter: function(v) { return v > 0 ? v + '%' : ''; }, style: { colors: ['#f1f5f9'], fontSize: '9px', fontWeight: 600 } },

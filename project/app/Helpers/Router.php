                ...
                try {
                    ...
                    if ($appConfig['debug']) {
                        echo '<div style="font-family:monospace;padding:20px;max-width:900px;margin:40px auto;background:#1a1a2e;color:#e2e8f0;border-radius:8px;">'
                            ...
                            . '<p style="color:#94a3b8;">' . e($e->getMessage()) . '</p>'
                            . '<p style="color:#64748b;font-size:0.85rem;">' . e($e->getFile()) . ':' . $e->getLine() . '</p>'
                            . '<pre style="color:#64748b;font-size:0.8rem;overflow:auto;">' . e($e->getTraceAsString()) . '</pre>'
                            . '</div>';
                    } else {
                        echo '<div style="text-align:center;padding:100px 20px;font-family:sans-serif;">'
                            . '<h1 style="font-size:3rem;color:#dc2626;">Erreur 500</h1>'
                            . '<p style="color:#6b7280;">Une erreur est survenue. L\'équipe technique a été notifiée.</p>'
                            . '<a href="/" style="color:#1a56db;">Retour à l\'accueil</a></div>';
                    }
                }
                return;
            }

...
class Lead
{
    ...
    public static function create(array $data): int
    {
        return Database::insert(
            "INSERT INTO leads (assessment_id, firstname, lastname, company, sector, job_title, phone, email, country, company_size, website, certifications, founded_year, production_type, production_capacity, machine_count, machine_types, notes, consent_contact, consent_share_industry) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
            [
                ...
                $data['production_capacity'] ?? '', $data['machine_count'] ?? null, $data['machine_types'] ?? '',
                $data['notes'] ?? '',

...
class AssessmentController
{
    ...
    public function saveLead(): void
    {
        ...
        $requiredFields = [
            'company', 'sector', 'activity_category', 'oem_tier', 'product_category',
            'country', 'company_size', 'founded_year', 'website', 'annual_revenue',
            'export_percentage', 'main_clients', 'production_sites', 'workforce_production',
            'workforce_engineering', 'job_title',
            'production_type', 'production_capacity', 'machine_count', 'machine_types',
            'main_materials', 'process_technologies', 'certifications', 'ppm_target',
            'otd_rate', 'fta_rate', 'scrap_rate', 'traceability_system',
            'logistics_system', 'rd_budget_percent', 'current_erp',
        ];
        $missing = [];
        ...
        if (!empty($missing)) {
            $_SESSION['error'] = 'Tous les champs du formulaire sont obligatoires. Veuillez compléter tous les champs marqués d\'un astérisque (*).';
